...
def prompt_manager_tab(page: ft.Page):
    ...
    def create_prompt_item(prompt_data, on_delete_prompt, on_update_order):
        ...
        display_title = ft.Text(value=prompt_title, weight="bold")
        ...
        display_view = ft.Row(
            ...
            controls=[
                ...
                ft.Row(
                    spacing=0,
                    controls=[
                        ft.IconButton(ft.Icons.ARROW_UPWARD, on_click=move_up, tooltip=i18n.get("prompt_manager_move_up")),
                        ft.IconButton(ft.Icons.ARROW_DOWNWARD, on_click=move_down, tooltip=i18n.get("prompt_manager_move_down")),
    ...
    view = ft.Column(
        controls=[
            ft.Text(i18n.get("prompt_manager_add_new_title", "Add New Prompt"), theme_style="headlineSmall"),
            new_prompt_title_field,
            new_prompt_content_field,
            ft.Row([add_prompt_button], alignment=ft.MainAxisAlignment.END),
            ft.Divider(),
            ft.Text(i18n.get("prompt_manager_existing_prompts_title", "Existing Prompts"), theme_style="headlineSmall"),
            prompt_list,
        ],
        expand=True,
